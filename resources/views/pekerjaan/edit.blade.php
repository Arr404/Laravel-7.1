...
<html lang="en">
    ...
    <div class="container">
        <div class=" form-row">
            <div class="col-lg-12">
                <h3>Edit Data Pekerjaan Alumni</h3>
            </div>
        </div>
        <br>
        ...
        <form action="{{route('pekerjaan.update',$pekerjaan->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nomorPekerjaan" class="form-control" id="nomorPekerjaan" value="{{$pekerjaan->nomorPekerjaan}}" placeholder="Nomor HP Pekerjaan">
                            </div>
                        </div>

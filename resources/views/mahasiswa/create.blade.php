...
<html lang="en">
    ...
    <div class="container">
        ...
        <form action="{{route('mahasiswa.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="gambarMahasiswa" class="col-sm-2 col-form-label">Upload gambar mahasiswa</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="ijazahMahasiswa" class="col-sm-2 col-form-label">Upload Ijazah mahasiswa</label>
                <div class="col-sm-10">

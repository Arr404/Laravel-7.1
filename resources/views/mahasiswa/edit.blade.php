...
<html lang="en">
    ...
    <div class="container">
        ...
        <form action="{{route('mahasiswa.update',$mahasiswa->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="gambarMahasiswa" class="col-sm-2 col-form-label">Update gambar Mahasiswa</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="ijazahMahasiswa" class="col-sm-2 col-form-label">Update Ijazah Mahasiswa</label>
                <div class="col-sm-10">
